...
def display_preloaded_map(threshold, map_folder):
    ...
    if response.status_code == 200:
        ...
        # Add slope formula and conversions here
        st.markdown("""
...
def main():
    ...
    if page == "Preloaded Slope Maps":
        ...
        slope_threshold = st.number_input("Enter the slope threshold percentage:", min_value=1, max_value=40, value=5, step=1)
